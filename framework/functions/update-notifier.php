...
define( 'NOTIFIER_THEME_NAME', 'Better Factories Cambodia' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'betterfactories' ); // The theme folder name
...
function update_notifier() { 
	...
	<div class="wrap">
		...
		<div id="instructions">
		    ...
		    <p>To update the Theme, login to <a href="http://wptheme.novacambodia.com/">Nova Wordpress Themes</a>, head over to your <strong>downloads</strong> section and re-download the theme like you did at the first time.</p>
