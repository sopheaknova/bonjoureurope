...
add_action('widgets_init','sp_widget_posts_category');

function sp_widget_posts_category() {
	register_widget('sp_widget_posts_category');
	
	}

class sp_widget_posts_category extends WP_Widget {
	function sp_widget_posts_category() {
